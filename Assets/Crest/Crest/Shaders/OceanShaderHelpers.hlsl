...
#define CREST_SAMPLE_SCENE_DEPTH_X(uv) SHADERGRAPH_SAMPLE_SCENE_DEPTH(uv)
#else
...
// Depth texture is now set up for MSAA without having to multi-sample.
#undef CREST_MULTISAMPLE_SCENE_DEPTH
#define CREST_MULTISAMPLE_SCENE_DEPTH(x, y) CREST_SAMPLE_SCENE_DEPTH_X(x)
#endif
#endif
