Shader "Custom/Nebula/SphereVolumeNebula"
{
    Properties
    {
        ...
        // 几何与密度（注意：Radius 在物体空间，默认球半径 0.5）
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct Varyings
            {
                ...
                float3 posWS      : TEXCOORD0; // 世界空间位置（用于算 ray）
            };
            ...
            float4 frag (Varyings i) : SV_Target
            {
                ...
                {
                    float3 p = roOS + rdOS * t;    // 物体空间采样点（在球内）
                    ...
                    float inner = _RingInnerRadius;
                    float outer = _RingOuterRadius;
                    ...
                    float d = baseNoise * detailNoise * shellFactor * dustMask;
                    d *= _Density;
